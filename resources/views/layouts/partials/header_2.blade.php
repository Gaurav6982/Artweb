...
background-image: linear-gradient(315deg, #ffe58d 60%,#ff9999 75%);">
    ...
    <div style="margin-left:-0px" data-animate="fadeInDown">
<div class="row">
  <div class="column" style="margin-left: 30px; height:54px; width:32%;padding-top:6px;" >
  ...
  <div class="column" style="width:890px;padding-right:40px;height:54px;" >
     <div  style="width:100%; ">
