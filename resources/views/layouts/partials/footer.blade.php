...
<footer class="main-footer main-footer-style-01 bg-pattern-01 pt-12 pb-8" style="background-color:#ffe58d;
background-image: linear-gradient(315deg, #ffe58d 60%,#ff9999 75%);">
    <div class="footer-second">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-4 mb-6 mb-lg-0">
                    <div class="mb-8"><img src="{{asset('images/logo.png')}}" style="height:100px"alt="Thedir"></div>
                    <div class="mb-7">
            ...
            <div class="footer-last-container position-relative">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 mb-3 mb-lg-0">
                        <div>
                            &copy; {{date('Y')}} <a href="{{route('home')}}" class="link-hover-dark-primary font-weight-semibold">{{config('default_var.website_company_name')}}.</a> All
                            Rights Resevered. <br>
